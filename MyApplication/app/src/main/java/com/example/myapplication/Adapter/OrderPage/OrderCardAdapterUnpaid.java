...
public class OrderCardAdapterUnpaid extends RecyclerView.Adapter <OrderCardAdapterUnpaid.ViewHolder> {

    private List<OrderCard> orderCards;
    private ServiceCardAdapter.OnItemClickListener myOnItemClickListener;


    public OrderCardAdapterUnpaid(List<OrderCard> orderCards) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_card_unpaid_item, parent, false);
        OrderCardAdapterUnpaid.ViewHolder viewHolder = new OrderCardAdapterUnpaid.ViewHolder(view);
        return viewHolder;
    }
