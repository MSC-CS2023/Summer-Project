...
public class OrderCardAdapterProcessing extends RecyclerView.Adapter <OrderCardAdapterProcessing.ViewHolder> {

    private List<OrderCard> orderCards;
    private ServiceCardAdapter.OnItemClickListener myOnItemClickListener;


    public OrderCardAdapterProcessing(List<OrderCard> orderCards) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_card_processing_item, parent, false);
        OrderCardAdapterProcessing.ViewHolder viewHolder = new OrderCardAdapterProcessing.ViewHolder(view);
        return viewHolder;
    }
